    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 mb-8 animate-pulse">
                {[...Array(4)].map((_, i) => (
                    <div key={i} className="border-none shadow-sm p-6 flex items-start justify-between bg-white rounded-lg">
                        <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6 mb-8 animate-pulse">
                {[...Array(2)].map((_, i) => (
                    <div key={i} className="border-none shadow-sm bg-white rounded-lg">
                        <div className="p-6">
